    ...
    <div>
      <footer className="footer justify-between px-16 bg-gray-700 dark:bg-gray-800 text-white p-10">
        ...
        <nav >
          ...
          <Link to='/allItems' className='text-gray-300'>All Items</Link>
          <Link to='/addItem' className='text-gray-300'>Add Item</Link>
          <Link to='/myItems' className='text-gray-300'>My Items</Link>
          <Link to='/recoverItems' className='text-gray-300'>Recover Items</Link>
        </nav>
        <nav>
          <h6 className="footer-title">Find Us Social</h6>
          ...
          <div className="join pt-4 lg:w-auto">
            <input
              type="text"
              placeholder="enter your email"
              className="input w-[150px] lg:w-[250px] input-bordered join-item" />
            <button className="btn bg-purple-500 join-item text-gray-100">Subscribe</button>
          </div>
        </nav>
      </footer>
      <hr/>
