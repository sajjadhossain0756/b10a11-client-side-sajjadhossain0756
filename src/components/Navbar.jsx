...
const Navbar = () => {
  ...
  return (
    <div className='navbar bg-gradient-to-r from-green-400 to-purple-500 text-white  shadow-sm px-5 lg:px-10 mx-auto sticky top-0 z-10 backdrop-blur-md bg-opacity-50'>
