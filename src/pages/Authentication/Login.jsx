...
const Login = () => {
  ...
  const handleSignIn = (e) => {
    ...
    signIn(email, password)
      ...
      .catch(error => {
        ...
        Swal.fire('your email or password invalid',error.message)
      })
  ...
  return (
    <div className='flex justify-center items-center min-h-[calc(100vh-306px)] my-12 pb-10'>
      <Helmet><title>Lost & Found/Login Page</title></Helmet>
      <div className='flex w-full max-w-sm mx-auto overflow-hidden lg:flex-row-reverse
          ...
          <form onSubmit={handleSignIn}>
            ...
            <div className='mt-4'>
              ...
              <input
                ...
                name='password'
                className='block w-full px-4 py-2 dark:text-white text-gray-700 bg-white border rounded-lg    focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300'
                type='password'
              />
            </div>
            <div className='mt-6'>
